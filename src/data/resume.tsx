...
export const DATA = {
  ...
  contactDescription:
    "Got something to discuss? Drop me a message on WhatsApp, and I'll get back to you when I'm free.",
  contact: {
    email: "yigaldev@gmail.com",
    tel: "+972 53 335 0910",
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/yigalipsey",
        icon: Icons.github,
        navbar: true,
      },
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/yigal-lipsey/",
        icon: Icons.linkedin,
        navbar: true,
      },
      WhatsApp: {
        name: "WhatsApp",
        url: "https://wa.me/972533350910",
        icon: Icons.whatsapp,
        navbar: true,
      },
      email: {
  ...
  projects: [
    ...
    {
      title: "smart sales",
      href: "https://smartsales-iota.vercel.app/",
      active: true,
      description:
        "Elegant online presence for an outsourced sales company. Highlights services, success stories, and expertise in driving revenue growth for businesses.",
      technologies: ["Next.js", "TailwindCSS", "framer-motion"],
      links: [
        {
          type: "Website",
